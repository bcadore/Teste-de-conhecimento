const perguntas = [
    ...
    {
      pergunta: "Como você verifica se duas variáveis são exatamente iguais em valor e tipo?",
      respostas: [
        "==",
        "===",
        "!=",
    ...
    {
      pergunta: "Qual operador é usado para verificar se um valor é maior ou igual a outro em JavaScript?",
      respostas: [
        ">=",
        "<=",
        "==",
